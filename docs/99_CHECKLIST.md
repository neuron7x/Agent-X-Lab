...
| CHK-CI-G3 | All `uses:` entries SHA-pinned. | docs/08_SECURITY_GATES.md#security-pinning | build_proof/ci_hardening/outputs/01_action_pin_audit.txt:L1-L40; build_proof/ci_hardening/outputs/12_not_pinned_check.txt:L1-L3 | PASS |
...
| ItemID | Requirement | Doc section anchor | Evidence anchors | Status |
|---|---|---|---|---|
| CHK-CI-BLOCK-LOGS | Decisive per-job error excerpts captured from GitHub Actions runs. | docs/08_SECURITY_GATES.md#security-evidence-limitations | build_proof/ci_hardening/outputs/15_gh_capability_check.txt:L1-L6; build_proof/ci_hardening/outputs/16_github_api_runs_probe.txt:L1-L3 | FAIL (cannot access runs/logs from this environment). |
...
| CHK-CI-BLOCK-CI-PASS | Proof that all required PR checks are green for PR #100 branch. | docs/08_SECURITY_GATES.md#security-evidence-limitations | build_proof/ci_hardening/outputs/15_gh_capability_check.txt:L1-L6; build_proof/ci_hardening/outputs/16_github_api_runs_probe.txt:L1-L3 | FAIL (verification blocked; operator runbook required). |
